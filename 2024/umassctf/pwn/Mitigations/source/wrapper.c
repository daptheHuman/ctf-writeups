...
#define MALLOC_ADDR 0x004019a0
#define AFTER_MALLOC_ADDR 0x00401a49
#define REALLOC_ADDR 0x00401a5f
#define AFTER_REALLOC_ADDR 0x00401b0f
#define READ_ADDR 0x00401b71
